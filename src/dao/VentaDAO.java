...
public class VentaDAO {
    ...
    public void registrarVenta(Venta venta) {
        ...
        try {
            ...
            // INSERTAR VENTA
            PreparedStatement psVenta = conexion.prepareStatement(sqlVenta,PreparedStatement.RETURN_GENERATED_KEYS);
    ...
    public void verDetalleVenta(int ventaId) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                System.out.println("Precio Unitario: S/ "+ rs.getDouble("precio_unitario"));
                System.out.println("Subtotal: S/ "+ rs.getDouble("subtotal"));
            }
    ...
    public void ventasPorFecha(String fechaInicio,String fechaFin) {
        String sql = """
                SELECT v.id,
                       c.nombre,
                       v.fecha,
    ...
    public void productosMasVendidos() {
        ...
        try {
            ...
            while (rs.next()) {
                System.out.println("\nProducto: "+ rs.getString("nombre"));
                System.out.println("Cantidad Vendida: "+ rs.getInt("total_vendido"));
            }

        } catch (SQLException e) {
            System.out.println("Error productos vendidos: "+ e.getMessage());
        }
    }
    ...
    public void totalVendido() {
        ...
        try {
            ...
            if (rs.next()) {
                System.out.println("\nTOTAL GENERAL VENDIDO: S/ "+ rs.getDouble("total_general"));
            }

        } catch (SQLException e) {
            System.out.println("Error total vendido: "+ e.getMessage());
        }
    }
}